...
var _MobileNav = __webpack_require__(8);
...
var Nav = function () {
	function Nav() {
		...
		this.navbar = (0, _jquery2.default)('.nav');
		this.links = (0, _jquery2.default)('.nav a, .nav__mobile a, .nav__footer__ul a, .btn-animated');
		this.liTags = (0, _jquery2.default)('.nav__li, .nav__footer__li');
		this.secTitle = (0, _jquery2.default)('.about');
		this.skillsTitle = (0, _jquery2.default)('.skills');
		this.contTitle = (0, _jquery2.default)('.contact');
		this.narrowNav();
		this.smoothing();
		this.addMenuActive();
		this.activeNav();
		...
		value: function narrowNav() {
			...
			new Waypoint({
				...
				handler: function handler(direction) {
					(0, _jquery2.default)('.nav__li').removeClass('nav__li--active');
					(0, _jquery2.default)('nav a#about-link > li').addClass('nav__li--active');
			...
			new Waypoint({
				...
				handler: function handler() {
					(0, _jquery2.default)('.about__desc').addClass('about__desc--visible');
					(0, _jquery2.default)('.about__pic').addClass('about__pic--visible');
				},
				offset: '90%'
			});
		}
...
var Footer = function () {
	function Footer() {
		...
		this.displayHour = (0, _jquery2.default)('.dispHour');
		this.displayMinute = (0, _jquery2.default)('.dispMin');
		this.displayYear = (0, _jquery2.default)('.dispDate');
		this.displayMonth = (0, _jquery2.default)('.dispMonth');
		this.displayDay = (0, _jquery2.default)('.dispDay');
		this.displyDayNum = (0, _jquery2.default)('.dispDayNum');
		this.separate = (0, _jquery2.default)('.separator, .welcome__span');
		this.showTime();
		this.flashingSep();
	}
	...
	_createClass(Footer, [{
		...
		key: "flashingSep",
		value: function flashingSep() {
			var that = this;
			setInterval(function () {
				that.separate.toggleClass('separator--on');
			}, 1000);
		}
	}]);
...
var MobileNav = function () {
	function MobileNav() {
		...
		this.menuIcon = (0, _jquery2.default)('.menu-bar');
		this.Menu = (0, _jquery2.default)('.nav__mobile');
		this.showMenu();
	}
